...
void EMfields3D::sumMoments_AoS(const Particles3Dcomm* part)
{
  ...
  /*    cout << "EMfields3D::sumMoments_AoS********************\n";
    cout << "ns = " << ns << "\n";
    cout << "********************\n";*/
...
void EMfields3D::sumMoments_vectorized_AoS(const Particles3Dcomm* part)
{
  ...
  cout << "EMfields3D::sumMoments_vectorized_AoS ********************\n";
  cout << "ns = " << ns << "\n";
  cout << "********************\n";
  for (int i = 0; i < ns; i++)
  {
...
void EMfields3D::test_communicateGhostP2G(int ns){

  //#pragma omp parallel
  
    //    id_thread = omp_get_thread_num();
    //   nthreads = omp_get_num_threads();
    //    cout << " id thread = " << id_thread << "\n"; 
